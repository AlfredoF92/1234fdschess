...
<div class="bmchess-root"><div class="page">
    <main class="game is-eval-side">
      <section class="board-col">
        <div class="board-with-eval">
          <div id="board-opp-preview" class="board-move-preview is-opp" data-i18n-aria="board.preview.opp" aria-label="Anteprima delle mosse dell'avversario">
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
          ...
          <div id="board-move-preview" class="board-move-preview" data-i18n-aria="board.preview" aria-label="Anteprima delle mosse suggerite">
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
            <div class="board-preview-item is-empty" aria-hidden="true"></div>
      ...
      <section class="coach-col">
        <div class="coach-side">
          <div id="eval-bar" class="eval-bar is-blocks is-vertical" data-i18n-aria="eval.bar" aria-label="Valutazione della posizione" role="meter" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50">
  ...
  <div id="quick-tools" class="quick-tools" hidden>
    <div class="quick-tools-card" role="dialog" aria-modal="true" aria-labelledby="quick-tools-title">
      ...
      <div class="quick-tools-rows">
        ...
        <div class="coach-row">
          <span class="coach-row-label" data-i18n="tools.evalBar.vertical">Barra verticale a destra</span>
          <button type="button" id="btn-eval-bar-vertical" class="coach-switch is-on" aria-pressed="true" data-i18n-aria="tools.evalBar.verticalAria" aria-label="Mostra la barra di valutazione in verticale a destra">On</button>
        </div>
  ...
  <div id="new-game" class="new-game" hidden>
    <div class="new-game-card" role="dialog" aria-modal="true" data-i18n-aria="newgame.title" aria-labelledby="new-game-title">
      ...
      <div id="panel-settings" class="new-game-panel new-game-form" role="tabpanel" data-panel="settings" aria-labelledby="tab-settings" hidden>
        ...
        <label class="skill-wrap">
          <span data-i18n="tools.evalBar.place">Posizione barra</span>
          <select id="eval-bar-place" data-i18n-aria="tools.evalBar.placeAria" aria-label="Dove mostrare la barra di valutazione">
            <option value="side" selected>Verticale a destra</option>
            <option value="under">Sotto la scacchiera</option>
          </select>
        </label>
        <p class="new-game-soon" data-i18n="tools.evalBar.placeHint">Di default la barra è verticale a destra, così al centro restano solo scacchiera e caselle.</p>
        <label class="skill-wrap">

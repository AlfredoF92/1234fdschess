...
const PIECE_SRC = {
  wp: asset("pieces/wP.svg"),
  wn: asset("pieces/wN.svg"),
  wb: asset("pieces/wB.svg"),
  wr: asset("pieces/wR.svg"),
  wq: asset("pieces/wQ.svg"),
  wk: asset("pieces/wK.svg"),
  bp: asset("pieces/bP.svg"),
  bn: asset("pieces/bN.svg"),
  bb: asset("pieces/bB.svg"),
  br: asset("pieces/bR.svg"),
  bq: asset("pieces/bQ.svg"),
  bk: asset("pieces/bK.svg"),
};
